...
//   const locationHeader = document.querySelector(".list-header h4");
//   if (locationHeader) {
//     locationHeader.textContent = `PHCs near ${searchedLocation}`;
//   }

//   // Get all the pre-defined PHC boxes
//   const phcBoxes = document.querySelectorAll("#phc-list .box");

//   // Hide all boxes first
//   phcBoxes.forEach((box) => {
//     box.style.display = "none";
//   });

//   // Update and show boxes for found PHCs
//   phcs.forEach((phc, index) => {
//     // Only update if we have a corresponding box
//     if (index < phcBoxes.length) {
//       const box = phcBoxes[index];

//       // Update the content
//       box.querySelector("h5").textContent = phc.name || "Unnamed PHC";
//       //   box.querySelector(".rating2").textContent = phc.rating || "N/A";
//       //   box.querySelector(".reviews2").textContent = `(${phc.reviews || "0"})`;
//       //   box.querySelector(".type2").textContent = phc.type || "Community HCC";
//       // box.querySelector(".address2").textContent =
//       // phc.address || `${phc.lga_name}, ${phc.state_name}`; used to show
//       // box.querySelector(".hours2").textContent = phc.hours || "Open 24 Hours"; used to show
//       //   box.querySelector(".phone2").textContent = phc.phone || "N/A";
//       box.querySelector(".distance").textContent = phc.distance
//         ? `${phc.distance.toFixed(1)} km away`
//         : "";

//       // Update the view more link's data attribute
//       const viewMoreLink = box.querySelector(".viewMore");
//       if (viewMoreLink) {
//         viewMoreLink.setAttribute("data-phc-id", phc.id || "");
//       }
...
//       displayPHCMarkersAndList(filteredPHCs, locationInput);
//     }
//   } catch (error) {
