...
function displayPHCMarkersAndList(filteredData, searchedLocation) {
  ...
  const typedLocationElements = document.getElementById("typedLocation");
  ...
  phcs.forEach((phc, index) => {
    ...
    if (index < phcBoxes.length) {
      ...
      box.querySelector(".address2").textContent =
        phc.address || `${phc.lga_name}, ${phc.state_name}`;
      box.querySelector(".hours2").textContent = phc.hours || "Open 24 Hours";
